...
export default function AppShell({role,title,children}){
 ...
 return <div className="app-shell">
  ...
  <main className="main"><header className="topbar"><div className="topbar-title"><div className="eyebrow">{role==="vendor"?"Vendor workspace":"Seller workspace"}</div><h1>{title}</h1></div><div className="topbar-actions"><div className="command-search">⌕ <span>Search products, orders, tools...</span><kbd>⌘ K</kbd></div><span className="online-pill"><i/> Online</span></div></header><div className="page">{children}</div></main>
 </div>;
}
